...
_Auto-generated 2026-09-11 23:08 UTC · covers 8 repos in `moodys-ma-mdc` · excludes `mdc-data-etl-mwaa-operational-glue`_

**[🔗 Open this view on GitHub search](https://github.com/search?q=is%3Apr%20is%3Aopen%20repo%3Amoodys-ma-mdc/mdc-data-search-quality-scripts%20repo%3Amoodys-ma-mdc/mdc-data-search%20repo%3Amoodys-ma-mdc/mdc-data-search-preprocessing%20repo%3Amoodys-ma-mdc/mdc-data-search-solr%20repo%3Amoodys-ma-mdc/mdc-data-search-glue%20repo%3Amoodys-ma-mdc/mdc-search%20repo%3Amoodys-ma-mdc/mdc-global-search-api%20repo%3Amoodys-ma-mdc/mdc-search-bot&type=pullrequests&s=updated&o=desc)** — paste into Slack, pin in Confluence. Add `author:@me` to scope to yourself.

**Stats:** 4 active today · 24 stale (>30d) · 8 dependabot · 11 drafts · **36 total**

<details><summary><b>mdc-data-search-solr</b> · 2 PRs</summary>

| PR | Title | Author | Age |
|---|---|---|---|
| [#43](https://github.com/moodys-ma-mdc/mdc-data-search-solr/pull/43) | [MDCPT-103828] Add Solr GC tuning and CloudWatch/PagerDuty alarms | `yahia-elakeed-se` | **today** |
| [#39](https://github.com/moodys-ma-mdc/mdc-data-search-solr/pull/39) | [CHORE] Update README.md | `yahia-elakeed-se` | ~7w |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#654](https://github.com/moodys-ma-mdc/mdc-search/pull/654) | feat: [MDCPT-86940] Restore types | `MaxAgliunin` | **today** |
| [#619](https://github.com/moodys-ma-mdc/mdc-search/pull/619) | [MDCPT-98932] Decouple search-bar from CV2 React 16 (consume shared R… _(draft)_ | `mmaestri` | 4d |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#444](https://github.com/moodys-ma-mdc/mdc-data-search/pull/444) | [CHORE] configure Waitress trusted_proxy to pass X-Forwarded-For from… _(draft)_ | `aftimosm` | **today** |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#82](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/82) | chore(deps-dev): bump baseline-browser-mapping from 2.10.35 to 2.11.2… | `dependabot[bot]` | **today** |
| [#81](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/81) | chore(deps-dev): bump postcss-selector-parser from 7.1.2 to 7.1.5 in… | `dependabot[bot]` | 9d |
| [#80](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/80) | chore(deps-dev): bump nanoid from 3.3.12 to 3.3.18 in /apps/api/cdk | `dependabot[bot]` | 25d |
| [#79](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/79) | chore(deps-dev): bump postcss from 8.5.15 to 8.5.26 in /apps/teams-re… | `dependabot[bot]` | ~5w |
| [#78](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/78) | chore(deps): bump cryptography from 48.0.0 to 50.0.0 in /apps/api | `dependabot[bot]` | ~5w |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#2827](https://github.com/moodys-ma-mdc/mdc-data-search-glue/pull/2827) | [MDCPT-101355] Worker adjustments for 2026 research baseline | `KavyaOS` | 1d |
| [#2799](https://github.com/moodys-ma-mdc/mdc-data-search-glue/pull/2799) | [CHORE] Read EAI peer group details parquet directory in a single Spa… | `ahmedhamdyse` | 23d |
| [#2767](https://github.com/moodys-ma-mdc/mdc-data-search-glue/pull/2767) | [MDCPT-95601] Fix research-sector S3-to-postgres KeyError on empty/un… | `ahmedhamdyse` | ~8w |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#339](https://github.com/moodys-ma-mdc/mdc-data-search-quality-scripts/pull/339) | [CHORE] MDC Learning-To-Rank POC | `sstults-non-empl` | 4d |
...
| [#525](https://github.com/moodys-ma-mdc/mdc-data-search-preprocessing/pull/525) | [MDCPT-65232] Ingest Additional Metadata to Add to Type-Ahead UI. | `ahmedhamdyse` | ~11mo |
