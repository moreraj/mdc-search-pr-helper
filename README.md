...
_Auto-generated 2026-09-03 17:44 UTC · covers 9 repos in `moodys-ma-mdc` · excludes `mdc-data-etl-mwaa-operational-glue`_

**[🔗 Open this view on GitHub search](https://github.com/search?q=is%3Apr%20is%3Aopen%20repo%3Amoodys-ma-mdc/mdc-search%20repo%3Amoodys-ma-mdc/mdc-data-search%20repo%3Amoodys-ma-mdc/mdc-data-api-search-config-v2%20repo%3Amoodys-ma-mdc/mdc-data-search-glue%20repo%3Amoodys-ma-mdc/mdc-data-etl-flaghub-glue%20repo%3Amoodys-ma-mdc/mdc-data-search-quality-scripts%20repo%3Amoodys-ma-mdc/mdc-search-bot%20repo%3Amoodys-ma-mdc/mdc-legacy-services-search%20repo%3Amoodys-ma-mdc/mdc-global-search-api&type=pullrequests&s=updated&o=desc)** — paste into Slack, pin in Confluence. Add `author:@me` to scope to yourself.

**Stats:** 2 active today · 26 stale (>30d) · 19 dependabot · 7 drafts · **37 total**

<details><summary><b>mdc-data-search</b> · 4 PRs</summary>

| PR | Title | Author | Age |
|---|---|---|---|
| [#426](https://github.com/moodys-ma-mdc/mdc-data-search/pull/426) | [MDCPT-102972] Selective field inclusion for anonymous-api V2 endpoin… | `aftimosm` | **today** |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#640](https://github.com/moodys-ma-mdc/mdc-search/pull/640) | fix: [MDCPT-102505] Suppress debt IDs in V2 tranche URLs when matched… | `aftimosm` | **today** |
...
| PR | Title | Author | Age |
|---|---|---|---|
| [#337](https://github.com/moodys-ma-mdc/mdc-data-search-quality-scripts/pull/337) | [CHORE] build(deps): bump tornado from 6.5.7 to 6.5.8 in /llm_judge_s… | `dependabot[bot]` | 1d |
| [#338](https://github.com/moodys-ma-mdc/mdc-data-search-quality-scripts/pull/338) | [CHORE] build(deps): bump transformers from 5.5.0 to 5.10.1 in /NerCo… | `dependabot[bot]` | 1d |
| [#336](https://github.com/moodys-ma-mdc/mdc-data-search-quality-scripts/pull/336) | [CHORE] build(deps): bump gitpython from 3.1.57 to 3.1.58 in /llm_jud… | `dependabot[bot]` | 24d |
...
<details><summary><b>mdc-search-bot</b> · 7 PRs</summary>

| PR | Title | Author | Age |
|---|---|---|---|
| [#81](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/81) | chore(deps-dev): bump postcss-selector-parser from 7.1.2 to 7.1.5 in… | `dependabot[bot]` | 1d |
| [#80](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/80) | chore(deps-dev): bump nanoid from 3.3.12 to 3.3.18 in /apps/api/cdk | `dependabot[bot]` | 17d |
...
| [#78](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/78) | chore(deps): bump cryptography from 48.0.0 to 50.0.0 in /apps/api | `dependabot[bot]` | 29d |
| [#77](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/77) | chore(deps-dev): bump postcss from 8.5.15 to 8.5.25 in /apps/api/cdk | `dependabot[bot]` | ~5w |
| [#76](https://github.com/moodys-ma-mdc/mdc-search-bot/pull/76) | chore(deps-dev): bump shell-quote from 1.8.4 to 1.10.0 in /apps/api/c… | `dependabot[bot]` | ~6w |
